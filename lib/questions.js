...
// ~25 preguntas: balance entre auditoría de COO y que el cliente NO abandone.
// Regla: todo debe responderse de memoria, sin buscar papeles.
// Lo pesado (costeo platillo x platillo, nómina detallada, estados financieros)
// se levanta en la sesión de consultoría, no aquí.
...
export const SECTIONS = [
  {
    ...
    questions: [
      ...
      { id: "anos", q: "¿Cuántos años tiene operando?", type: "text", ph: "ej. 7 años" },
      { id: "capacidad", q: "¿Cuántas mesas / comensales caben?", type: "text", ph: "ej. 22 mesas, 90 personas" },
    ],
  },
  {
    ...
    questions: [
      ...
      { id: "dia_pico", q: "¿Cuál es tu día más fuerte de la semana?", type: "choice", opts: ["Sábado", "Domingo", "Viernes", "Parejo / otro"] },
      ...
      { id: "temporada", q: "¿Qué tanto cambia tu venta entre temporada alta y baja?", type: "choice", opts: ["Muchísimo (la temporada me sostiene)", "Bastante", "Poco, es parejo"] },
      { id: "alta", q: "¿Cuál es tu temporada más fuerte?", type: "area", ph: "ej. Cuaresma, verano, vacaciones..." },
      { id: "bebidas", q: "¿Qué parte de la venta son bebidas (cerveza, micheladas, refrescos)?", type: "choice", opts: ["Mucha (30%+)", "Algo (~20%)", "Poca", "No sé"] },
      { id: "pago", q: "¿Cómo te pagan más tus clientes?", type: "choice", opts: ["Efectivo", "Tarjeta", "Mitad y mitad", "Transferencia / otro"] },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "dependencia", q: "Si tu proveedor principal te falla un fin de semana, ¿qué tan grave es?", type: "choice", opts: ["Gravísimo, dependo de él", "Me complico pero salgo", "Tengo de dónde echar mano"] },
      ...
      { id: "insumos_caros", q: "¿Tus 3 insumos más caros?", type: "area", ph: "ej. camarón, pulpo, huachinango..." },
    ],
  },
  {
    tag: "Mano de obra",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "quejas", q: "¿Cuál es la queja más común de tus clientes?", type: "area", ph: "ej. tardanza, precio, sazón, estacionamiento..." },
    ],
  },
  {
    tag: "Atraer clientes",
